...
// Namespace assumed from your original code
namespace CDS.CSharpScriptUtils.APIInfo
{
    // --- Data Models (Provided by User) ---
    ...
    public static class APIInfoService
    {
        ...
        private static readonly SymbolDisplayFormat MinimallyQualifiedFormat = new SymbolDisplayFormat(
            ...
            memberOptions: SymbolDisplayMemberOptions.IncludeParameters | SymbolDisplayMemberOptions.IncludeType | SymbolDisplayMemberOptions.IncludeModifiers | SymbolDisplayMemberOptions.IncludeRef,
            ...
            miscellaneousOptions: SymbolDisplayMiscellaneousOptions.UseSpecialTypes | SymbolDisplayMiscellaneousOptions.EscapeKeywordIdentifiers | SymbolDisplayMiscellaneousOptions.IncludeNullableReferenceTypeModifier // Added for nullable awareness
